...
import BuscarMaestrosAdministrativos from "@/models/maestros-administrativos/components/buscar";
import TablaDatosMaestrosAdministrativosRegistrados from "@/models/maestros-administrativos/components/tablaDatos";

const NuevoAccesoMaestrosAdministrativos = async ({
  searchParams,
}: {
  searchParams?: {
    query?: string;
  ...
  return (
    <div className="flex justify-center flex-col items-center">
      ...
      <div className="overflow-x-auto flex flex-col justify-center items-center text-center py-2 my-5">
        <BuscarMaestrosAdministrativos />
        <Suspense key={query} fallback={<Spinner />}>
          <TablaDatosMaestrosAdministrativosRegistrados query={query} />
        </Suspense>
      </div>
    </div>
  );
...
export default NuevoAccesoMaestrosAdministrativos;
