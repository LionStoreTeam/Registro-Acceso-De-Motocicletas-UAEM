...
import { guardarRegistroMaestroAdministrativo } from "@/controllers/maestros-administrativos/action";
import Link from "next/link";

const RegistroMaestrosAdministrativosMotocicletas = () => {
  const [estadoSeleccionado, setEstadoSeleccionado] = useState<string>("");
  const [municipioSeleccionado, setMunicipioSeleccionado] =
    useState<string>("");
  const [state, formAction] = useFormState(
    guardarRegistroMaestroAdministrativo,
    null
  );
              ...
              <div className="rounded-t-xl bg-slate-200 mb-0 px-6 py-6">
                <div className="text-center flex justify-between">
                  <h6 className="text-blueGray-700 text-xl font-bold">
                    AÑADIR NUEVO REGISTRO - MAESTRO/ADMINISTRATIVO
                  </h6>
                </div>
              </div>
...
export default RegistroMaestrosAdministrativosMotocicletas;
