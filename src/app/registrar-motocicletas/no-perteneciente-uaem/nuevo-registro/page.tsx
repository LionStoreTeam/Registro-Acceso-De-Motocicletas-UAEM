...
import { guardarRegistroNoPertenecienteUAEM } from "@/controllers/no-perteneciente-uaem/action";
import Link from "next/link";

const RegistroNoPertenecientesUAEMMotocicletas = () => {
  const [estadoSeleccionado, setEstadoSeleccionado] = useState<string>("");
  const [municipioSeleccionado, setMunicipioSeleccionado] =
    useState<string>("");
  const [state, formAction] = useFormState(
    guardarRegistroNoPertenecienteUAEM,
    null
  );
              ...
              <div className="rounded-t-xl bg-slate-200 mb-0 px-6 py-6">
                <div className="text-center flex justify-between">
                  <h6 className="text-blueGray-700 text-xl font-bold">
                    AÑADIR NUEVO REGISTRO - NO PERTENECIENTE UAEM
                  </h6>
                </div>
              </div>
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          ...
                          pattern="[0-9]+"
                          placeholder="Matricula: 0123456789"
...
export default RegistroNoPertenecientesUAEMMotocicletas;
