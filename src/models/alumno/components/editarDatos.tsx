...
import type { Estudiantes } from "@prisma/client";
import { updateRegistroAlumno } from "@/controllers/alumnos/action";
import Link from "next/link";
import Image from "next/image";
import { useState } from "react";
import estados from "@/models/estados";

const EditarDatosEstudiantes = ({
  estudiantes,
}: {
  estudiantes: Estudiantes;
}) => {
  const UpdateEstudianteWithId = updateRegistroAlumno.bind(
    null,
    estudiantes.id
  );
  const [state, formAction] = useFormState(UpdateEstudianteWithId, null);
  ...
  // <h1>Tu id es: {estudiantes.id}</h1>
  // <h1>Tu nombre es: {estudiantes.matriculaEscolar}</h1>
  // <h1>Tu nombre es: {estudiantes.nombre}</h1>
  // <h1>Tu nombre es: {estudiantes.correoInstitucional}</h1>
  // <h1>
  //   La fecha de creación fue:{" "}
  //   {estudiantes.createdAt.toLocaleDateString() +
  //     "  " +
  //     estudiantes.createdAt.toLocaleTimeString()}
  // </h1>
  return (
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.matriculaEscolar}
                          minLength={8}
                          maxLength={8}
                          type="tel"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.nombre}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="nombre"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.correoInstitucional}
                          autoComplete="off"
                          type="email"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.apellidoPaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.apellidoMaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.direccion}
                          maxLength={50}
                          type="text"
                          name="direccion"
                          id="direccion"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={estudiantes.estado}
                          id="estado"
                          name="estado"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={estudiantes.municipio}
                          autoComplete="off"
                          name="municipio"
                          id="municipio"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.codigoPostal}
                          minLength={5}
                          maxLength={5}
                          autoComplete="off"
                          type="tel"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.matriculaVehicular}
                          minLength={7}
                          maxLength={8}
                          autoComplete="off"
                          type="tel"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.modelo}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="modelo"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.anioRegistro}
                          autoComplete="off"
                          type="date"
                          name="anioRegistro"
                          id="anioRegistro"
                    ...
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.infoAdVehiculo}
                          maxLength={100}
                          autoComplete="off"
                          type="text"
                          name="infoAdVehiculo"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={estudiantes.notasDescriptivas}
                          maxLength={100}
                          autoComplete="off"
                          type="text"
...
export default EditarDatosEstudiantes;
