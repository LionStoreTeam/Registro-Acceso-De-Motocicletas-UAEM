...
import type { Estudiantes, MaestrosAdministrativos } from "@prisma/client";
import Link from "next/link";
import Image from "next/image";
import { useState } from "react";
import estados from "@/models/estados";
import { updateRegistroMaestroAdministrativo } from "@/controllers/maestros-administrativos/action";

const EditarDatosMaestroAdministrativo = ({
  maestrosAdministrativos,
}: {
  maestrosAdministrativos: MaestrosAdministrativos;
}) => {
  const UpdateMaestrosAdministrativosWithId =
    updateRegistroMaestroAdministrativo.bind(null, maestrosAdministrativos.id);
  const [state, formAction] = useFormState(
    UpdateMaestrosAdministrativosWithId,
    null
  );
              ...
              <div className="rounded-t-xl bg-slate-200 mb-0 px-6 py-6">
                <div className="text-center flex justify-between">
                  <h6 className="text-blueGray-700 text-xl font-bold">
                    EDITAR REGISTRO - MAESTRO/ADMINISTRATIVO
                  </h6>
                </div>
              </div>
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        <label
                          ...
                          htmlFor="matriculaAcademica"
                        >
                          Matricula Escolar
                        </label>
                        <input
                          defaultValue={
                            maestrosAdministrativos.matriculaAcademica
                          }
                          minLength={8}
                          maxLength={8}
                          type="tel"
                          name="matriculaAcademica"
                          id="matriculaAcademica"
                          pattern="[0-9]+"
                        ...
                        >
                          <p className="mt-2 text-sm text-red-500">
                            {state?.Error?.matriculaAcademica}
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          ...
                          className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        >
                          <option value="Maestro/Administrativo UAEM">
                            Maestro/Administrativo UAEM
                          </option>
                        </select>
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.nombre}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="nombre"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={
                            maestrosAdministrativos.correoInstitucional
                          }
                          autoComplete="off"
                          type="email"
                          name="correoInstitucional"
                          id="correoInstitucional"
                          placeholder="correo@uaem.mx"
                          className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        />
                        <div
                          id="name-error"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.apellidoPaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.apellidoMaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.direccion}
                          maxLength={50}
                          type="text"
                          name="direccion"
                          id="direccion"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={maestrosAdministrativos.estado}
                          id="estado"
                          name="estado"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={maestrosAdministrativos.municipio}
                          autoComplete="off"
                          name="municipio"
                          id="municipio"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.codigoPostal}
                          minLength={5}
                          maxLength={5}
                          autoComplete="off"
                          type="tel"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={
                            maestrosAdministrativos.matriculaVehicular
                          }
                          minLength={7}
                          maxLength={8}
                          autoComplete="off"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.modelo}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="modelo"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.anioRegistro}
                          autoComplete="off"
                          type="date"
                          name="anioRegistro"
                          id="anioRegistro"
                    ...
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={maestrosAdministrativos.infoAdVehiculo}
                          maxLength={100}
                          autoComplete="off"
                          type="text"
                          name="infoAdVehiculo"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={
                            maestrosAdministrativos.notasDescriptivas
                          }
                          maxLength={100}
                          autoComplete="off"
                          type="text"
...
export default EditarDatosMaestroAdministrativo;
