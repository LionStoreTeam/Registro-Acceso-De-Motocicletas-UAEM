...
import type { NoPertenecientesUAEM } from "@prisma/client";
import Link from "next/link";
import Image from "next/image";
import { useState } from "react";
import estados from "@/models/estados";
import { updateRegistroNoPertenecienteUAEM } from "@/controllers/no-perteneciente-uaem/action";

const EditarDatosNoPertenecienteUAEM = ({
  noPertenecientesUAEM,
}: {
  noPertenecientesUAEM: NoPertenecientesUAEM;
}) => {
  const UpdateNoPertenecienteUAEMWithId =
    updateRegistroNoPertenecienteUAEM.bind(null, noPertenecientesUAEM.id);
  const [state, formAction] = useFormState(
    UpdateNoPertenecienteUAEMWithId,
    null
  );
              ...
              <div className="rounded-t-xl bg-slate-200 mb-0 px-6 py-6">
                <div className="text-center flex justify-between">
                  <h6 className="text-blueGray-700 text-xl font-bold">
                    EDITAR REGISTRO - NO PERTENECIENTES UAEM
                  </h6>
                </div>
              </div>
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        <label
                          ...
                          htmlFor="matriculaAsignada"
                        >
                          Matricula Escolar
                        </label>
                        <input
                          defaultValue={noPertenecientesUAEM.matriculaAsignada}
                          minLength={8}
                          maxLength={8}
                          type="tel"
                          name="matriculaAsignada"
                          id="matriculaAsignada"
                          pattern="[0-9]+"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          ...
                          className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        >
                          <option value="NoPertenecienteUAEM">
                            No Perteneciente UAEM
                          </option>
                        </select>
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.nombre}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="nombre"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        <label
                          className="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                          htmlFor="correoGeneral"
                        >
                          Correo Institucional
                        </label>
                        <input
                          defaultValue={noPertenecientesUAEM.correoGeneral}
                          autoComplete="off"
                          type="email"
                          name="correoGeneral"
                          id="correoGeneral"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.apellidoPaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.apellidoMaterno}
                          maxLength={30}
                          autoComplete="off"
                          type="text"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.direccion}
                          maxLength={50}
                          type="text"
                          name="direccion"
                          id="direccion"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={noPertenecientesUAEM.estado}
                          id="estado"
                          name="estado"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <select
                          defaultValue={noPertenecientesUAEM.municipio}
                          autoComplete="off"
                          name="municipio"
                          id="municipio"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.codigoPostal}
                          minLength={5}
                          maxLength={5}
                          autoComplete="off"
                          type="tel"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.matriculaVehicular}
                          minLength={7}
                          maxLength={8}
                          autoComplete="off"
                          type="tel"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.modelo}
                          maxLength={20}
                          autoComplete="off"
                          type="text"
                          name="modelo"
                    ...
                    <div className="w-full lg:w-4/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.anioRegistro}
                          autoComplete="off"
                          type="date"
                          name="anioRegistro"
                          id="anioRegistro"
                    ...
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.infoAdVehiculo}
                          maxLength={100}
                          autoComplete="off"
                          type="text"
                          name="infoAdVehiculo"
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          defaultValue={noPertenecientesUAEM.notasDescriptivas}
                          maxLength={100}
                          autoComplete="off"
                          type="text"
...
export default EditarDatosNoPertenecienteUAEM;
